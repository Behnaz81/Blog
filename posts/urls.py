...
from posts.views import CategoryViewSet, PostFilteredByCategory, CreatePostView, ListPostsView, RetrievePostView, PostFilteredByUser, DeletePostView, UpdatePostView
